...
const TEMPLATE_TOKEN_REQUIREMENTS = {
  'studio/agent_clip': ['start', 'end', 'summary', 'location', 'characters'],
  'studio/screenplay_conversion': [
    'clip_id',
    'original_text',
    'scenes',
    'heading',
  ...
  'studio/agent_storyboard_detail': [
    'panel_number',
    'description',
    'characters',
    'location',
  ...
  'studio/agent_storyboard_insert': [
    'panel_number',
    'description',
    'characters',
    'location',
