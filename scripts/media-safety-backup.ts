...
async function snapshotTables(backupDir: string) {
  const tasks: SnapshotTask[] = [
    ...
    { name: 'studio_projects', tableName: 'studio_projects' },
    { name: 'studio_episodes', tableName: 'studio_episodes' },
    { name: 'studio_panels', tableName: 'studio_panels' },
    { name: 'studio_voice_lines', tableName: 'studio_voice_lines' },
