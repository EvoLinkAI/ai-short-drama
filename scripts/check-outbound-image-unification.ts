...
const mustIncludeRules: Rule[] = [
  ...
  {
    file: 'src/app/api/studio/[projectId]/modify-asset-image/route.ts',
    pattern: /sanitizeImageInputsForTaskPayload/,
    message: 'modify-asset-image route must sanitize image inputs',
  },
  {
    file: 'src/app/api/studio/[projectId]/modify-storyboard-image/route.ts',
    pattern: /sanitizeImageInputsForTaskPayload/,
  ...
  {
    file: 'src/lib/studio/stages/video-stage-runtime-core.tsx',
    pattern: /onPreviewImage=\{setPreviewImage\}/,
    message: 'Video stage runtime must wire preview callback to VideoPanelCard',
  },
  {
    file: 'src/app/[locale]/workspace/[projectId]/modes/studio/components/video/panel-card/types.ts',
    pattern: /onPreviewImage\?:\s*\(imageUrl:\s*string\)\s*=>\s*void/,
    message: 'VideoPanelCard runtime props must expose onPreviewImage',
  },
  {
    file: 'src/app/[locale]/workspace/[projectId]/modes/studio/components/video/panel-card/VideoPanelCardHeader.tsx',
