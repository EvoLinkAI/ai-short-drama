...
import type { StudioShot } from '@/types/project'
...
export function usePromptStageActions({
  ...
  const isShotTaskRunning = useCallback((shot: StudioShot) => {
    return Boolean((shot as StudioShot & { imageTaskRunning?: boolean }).imageTaskRunning)
  }, [])
