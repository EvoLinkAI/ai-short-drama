...
// Auth intentionally omitted: this route serves local media files referenced by
// MediaObject.storageKey. The /m/[publicId] public media route fetches from here
// server-side. Path traversal is guarded by normalizedPath check below.
// External users cannot guess storageKeys without database access.
