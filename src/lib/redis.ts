...
const globalForRedis = globalThis as typeof globalThis & {
  __aidramaStudioRedis?: RedisSingleton
}
...
const singleton = globalForRedis.__aidramaStudioRedis || {}
if (!globalForRedis.__aidramaStudioRedis) {
  globalForRedis.__aidramaStudioRedis = singleton
}
