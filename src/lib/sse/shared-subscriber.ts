...
type GlobalSharedSubscriber = typeof globalThis & {
  __appSharedSubscriber?: SharedSubscriber
}
...
export function getSharedSubscriber() {
  if (!globalForSharedSubscriber.__appSharedSubscriber) {
    globalForSharedSubscriber.__appSharedSubscriber = new SharedSubscriber()
  }
  return globalForSharedSubscriber.__appSharedSubscriber
}
